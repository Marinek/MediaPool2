package de.mediapool.server.rest.module.entities.controller;
...
import de.mediapool.server.rest.module.entities.listing.controller.ListingController;
...
public class TestProductController implements MPController {
	...
	public void createAll() {
		...
		User newUser1 = userController.findByUsername("mp@mp.de");
